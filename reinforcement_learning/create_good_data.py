# produce good outputs for the reward_trainer using our best model
...
peft_model = PeftModel.from_pretrained(base_model, "../fullRun/lorasConfig1/checkpoint-862/") 

FastLanguageModel.for_inference(peft_model)
device = torch.device("cuda")

create_output_files("good_data")
